...
<head>
    ...
    <title>{{ config('app.name', 'Asisten Belajar AI') }}</title>
            ...
            <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <svg class="h-9 w-auto text-indigo-600" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 640">
                            <path
                        ...
                        <span class="text-xl font-bold text-gray-800 ml-2">Asisten Belajar AI</span>
                    </div>
                        ...
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}"
                                    class="text-sm font-medium text-gray-600 hover:text-indigo-600 transition">Dashboard</a>
                            @else
                                <a href="{{ route('login') }}"
                                    class="text-sm font-medium text-gray-600 hover:text-indigo-600 transition">Log in</a>
            ...
            <div class="relative pt-16 sm:pt-24 lg:pt-32">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                        ...
                        <span class="block text-indigo-600 xl:inline">Belajar Mandiri Anda.</span>
                    </h1>
                    <p class="mt-3 max-w-md mx-auto text-base text-gray-600 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                        Ubah cara Anda belajar. Gunakan Asisten Belajar AI untuk memahami dokumen akademik,
                        bertanya secara kontekstual, dan melacak progres belajar Anda.
                    </p>
                    <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                        <div class="rounded-md shadow">
                            <a href="{{ route('register') }}"
                                class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 transition">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-12 grid gap-10 md:grid-cols-3">
                    ...
                    <div class="flex flex-col items-center text-center p-6">
                        ...
                        <p class="mt-2 text-base text-gray-600">
                            Ukur pemahaman Anda sebelum (Pre-Test) dan sesudah (Post-Test) membaca dengan kuis
                            terstruktur.
                        </p>
                    </div>
                    {{-- Fitur 3 --}}
                    <div class="flex flex-col items-center text-center p-6">
                        ...
                        <p class="mt-2 text-base text-gray-600">
                            Pantau progres membaca dan riwayat nilai tes Anda melalui dashboard yang intuitif dan
                            personal.
                        </p>
                    </div>
                </div>
        ...
        <footer class="bg-gray-50">
            <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <p class="text-center text-base text-gray-500">
                    &copy; {{ date('Y') }} Asisten Belajar AI. Dibuat untuk Tugas Akhir.
                </p>
            </div>
        </footer>
    </div>
